...
def Node2Vec_PCA_test(config):
    ...
    pca = PCATest(node2vec.embeddings, node2vec.has_feature, location, n_components=2, random_state=0)
    show_evaluation_results(config, node2vec, pca, k=10)